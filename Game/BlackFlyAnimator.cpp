...
void BlackFlyAnimator::OnAwake()
{
	m_default = new Animation(true);
	m_default->AddSprite(0, SpriteManager::Find(TEXT("monster_010_eternalfly/black01")));
	m_default->AddSprite(0.05f, SpriteManager::Find(TEXT("monster_010_eternalfly/black02")));
...
void BlackFlyAnimator::OnSetDefaultAnimation(Animation** defaultAnimtiaon)
{
}

void BlackFlyAnimator::OnUpdate(Animation* currentAnimation, const float& Elapsed)
{
}

void BlackFlyAnimator::OnAnimationChanged(Animation* prev, Animation* next)
{
	if (prev == m_dead && next == nullptr)
		OnDeadAnimated();
}

void BlackFlyAnimator::OnPrevDestroy()
{
}

void BlackFlyAnimator::PlayDefault()
{
...
void BlackFlyAnimator::PlayDead()
{
